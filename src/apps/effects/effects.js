...
export const EFFECTS = [
  {
    ...
    name: 'Dither',
    blurb:
      'Reduces the image to a handful of tones and fakes the missing shades with patterned dots.',
    params: [
      {
        key: 'algorithm',
        label: 'Algorithm',
      ...
      },
      {
        ...
        step: 1,
        def: 2,
        help: 'Size of the dither pixels — bigger looks chunkier and more retro.',
      },
      {
        key: 'threshold',
        label: 'Threshold',
        ...
        step: 0.01,
        def: 0,
        help: 'Shifts the balance between dark and light dots.',
      },
      {
        key: 'colors',
        label: 'Colors',
        ...
        step: 1,
        def: 2,
        help: 'Number of tones kept per color channel.',
      },
    ],
    frag: /* glsl */ `
...
void main(){
...

  {
    ...
    name: 'Bitmap',
    blurb:
      'Crushes the video to pure 1-bit: every pixel becomes either the foreground or the background color.',
    params: [
      {
        key: 'threshold',
        label: 'Threshold',
        ...
        step: 0.01,
        def: 0.5,
        help: 'Brightness cut-off between background and foreground.',
      },
      {
        key: 'pixelSize',
        label: 'Pixel size',
        ...
        step: 1,
        def: 4,
        help: 'Size of the bitmap blocks — bigger means blockier.',
      },
      {
        key: 'fg',
        ...
        kind: 'color',
        def: '#ffffff',
        help: 'Color used where the video is brighter than the threshold.',
      },
      {
        key: 'bg',
        ...
        kind: 'color',
        def: '#000000',
        help: 'Color used where the video is darker than the threshold.',
      },
    ],
    frag: /* glsl */ `
    ...
    params: [
      {
        ...
        step: 0.05,
        def: 1,
        help: 'Maximum size of the ink dots relative to the grid.',
      },
      {
        key: 'spacing',
        label: 'Spacing',
        ...
        step: 1,
        def: 9,
        help: 'Distance between dot centers, in pixels.',
      },
      {
        key: 'angle',
        label: 'Angle',
      ...
      },
      {
        ...
        step: 0.05,
        def: 1,
        help: 'Pushes tones apart before they become dots.',
      },
    ],
    frag: /* glsl */ `
...

  {
    ...
    params: [
      ...
      },
      {
        ...
        step: 0.01,
        def: 0.45,
        help: 'Brightness above which pixels join a sorted run.',
      },
      {
        key: 'length',
        label: 'Length',
        ...
        step: 1,
        def: 32,
        help: 'Maximum length of a streak, in pixels.',
      },
      {
        key: 'intensity',
        label: 'Intensity',
        ...
        step: 0.01,
        def: 0.8,
        help: 'How strongly runs get stretched into streaks.',
      },
    ],
    frag: /* glsl */ `
...

  {
    ...
    params: [
      ...
      },
      {
        ...
        step: 1,
        def: 0,
        help: 'Rotates the whole tile grid, in degrees.',
      },
      {
        key: 'distortion',
        label: 'Distortion',
        ...
        step: 0.01,
        def: 0,
        help: 'Randomly nudges each tile’s sampling point for a hand-made look.',
      },
    ],
    frag: /* glsl */ `
...
void main(){
...

  {
    ...
    name: 'Voronoi',
    blurb:
      'Shatters the image into organic cells, like stained glass grown from random seed points.',
    params: [
      {
        key: 'cellSize',
        label: 'Cell size',
        ...
        step: 1,
        def: 26,
        help: 'Average size of the cells, in pixels.',
      },
      {
        key: 'randomness',
        label: 'Randomness',
        ...
        step: 0.01,
        def: 1,
        help: 'How far seed points wander from a regular grid.',
      },
      {
        key: 'edgeWidth',
        label: 'Edge width',
        ...
        step: 0.005,
        def: 0.06,
        help: 'Thickness of the dark line between cells.',
      },
      {
        key: 'sampling',
        label: 'Sampling mode',
    ...
    params: [
      {
        ...
        step: 1,
        def: 12,
        help: 'Size of each character cell, in pixels.',
      },
      {
        key: 'charset',
        label: 'Character set',
      ...
      },
      {
        ...
        step: 0.05,
        def: 1,
        help: 'Pushes tones apart before picking characters.',
      },
      {
        key: 'colorMode',
        label: 'Color mode',
    ...
    params: [
      {
        ...
        step: 1,
        def: 6,
        help: 'Number of mirrored wedges around the center.',
      },
      {
        key: 'rotation',
        label: 'Rotation',
        ...
        step: 1,
        def: 0,
        help: 'Spins the whole pattern, in degrees.',
      },
      {
        key: 'zoom',
        label: 'Zoom',
        ...
        step: 0.01,
        def: 1,
        help: 'Zooms the sampled wedge in or out.',
      },
      {
        key: 'center',
        label: 'Center',
        ...
        step: 0.01,
        def: { x: 0.5, y: 0.5 },
        help: 'Where the mirrors converge on the image.',
      },
    ],
    frag: /* glsl */ `
...
void main(){
...

  {
    ...
    name: 'Slit Scan',
    blurb:
      'Builds each slice of the frame from a different moment in time, warping motion into liquid ribbons.',
    type: 'history',
    params: [
      {
        key: 'sdir',
      ...
      },
      {
        ...
        step: 1,
        def: 14,
        help: 'How many frames back the oldest slice reaches.',
      },
      {
        key: 'sliceWidth',
        label: 'Slice width',
        ...
        step: 1,
        def: 4,
        help: 'Thickness of each time slice, in pixels.',
      },
      {
        key: 'speed',
        label: 'Speed',
        ...
        step: 0.05,
        def: 1,
        help: 'How fast the time offset pattern scrolls.',
      },
    ],
    frag: /* glsl */ `
...
void main(){
...

  {
    ...
    name: 'RGB Delay',
    blurb:
      'Plays the red, green and blue channels at different points in time, so motion splits into colored ghosts.',
    type: 'history',
    params: [
      {
        key: 'redDelay',
        ...
        step: 1,
        def: 0,
        help: 'How many frames the red channel lags behind.',
      },
      {
        key: 'greenDelay',
        label: 'Green delay',
        ...
        step: 1,
        def: 6,
        help: 'How many frames the green channel lags behind.',
      },
      {
        key: 'blueDelay',
        label: 'Blue delay',
        ...
        step: 1,
        def: 12,
        help: 'How many frames the blue channel lags behind.',
      },
      {
        key: 'spatialOffset',
        label: 'Spatial offset',
        kind: 'range',
        min: -40,
        max: 40,
        step: 1,
        def: 0,
        help: 'Also shifts the channels sideways, in pixels.',
      },
    ],
    frag: /* glsl */ `
...
void main(){
...

  {
    ...
    name: 'Frame Echo',
    blurb:
      'Layers fading copies of past frames on top of the present, so movement leaves repeating ghosts.',
    type: 'history',
    params: [
      {
        key: 'delay',
        ...
        step: 1,
        def: 3,
        help: 'Frames between one echo and the next.',
      },
      {
        key: 'echoCount',
        label: 'Echo count',
        ...
        step: 1,
        def: 4,
        help: 'How many past copies are layered in.',
      },
      {
        key: 'decay',
        label: 'Decay',
        ...
        step: 0.01,
        def: 0.65,
        help: 'How quickly older echoes fade out.',
      },
      {
        key: 'blendMode',
        label: 'Blend mode',
...
void main(){
...

  {
    ...
    name: 'Feedback',
    blurb:
      'Feeds the output back into itself like a camera pointed at its own monitor — endless recursive trails.',
    type: 'feedback',
    params: [
      {
        key: 'persistence',
        ...
        step: 0.005,
        def: 0.92,
        help: 'How long the previous frames survive in the loop.',
      },
      {
        key: 'zoom',
        label: 'Zoom',
        ...
        step: 0.001,
        def: 1.02,
        help: 'The loop zooms in (>1) or out (<1) every frame.',
      },
      {
        key: 'rotFeed',
        label: 'Rotation',
        ...
        step: 0.1,
        def: 1,
        help: 'The loop rotates by this many degrees every frame.',
      },
      {
        key: 'offset',
        label: 'Offset',
        ...
        step: 0.0005,
        def: { x: 0, y: 0 },
        help: 'The loop drifts sideways by this much every frame.',
      },
    ],
    frag: /* glsl */ `
...
void main(){
...

  {
    ...
    name: 'Optical Flow',
    blurb:
      'Estimates where pixels are moving between frames and paints glowing, smearing trails along the motion.',
    type: 'flow',
    params: [
      {
        key: 'strength',
        ...
        step: 0.05,
        def: 1,
        help: 'How strongly detected motion colors and drags the image.',
      },
      {
        key: 'trail',
        label: 'Trail length',
        ...
        step: 0.01,
        def: 0.85,
        help: 'How long motion trails linger before fading.',
      },
      {
        key: 'sensitivity',
        label: 'Sensitivity',
        ...
        step: 0.1,
        def: 3,
        help: 'How small a movement still registers as flow.',
      },
      {
        key: 'distortion',
        label: 'Distortion',
        ...
        step: 0.05,
        def: 1,
        help: 'How much the image itself gets pushed along the flow.',
      },
    ],
    frag: /* glsl */ `
...
void main(){
...

  {
    ...
    name: 'VHS',
    blurb:
      'Degrades the video like a worn tape: grain, wobbly lines, tracking glitches and smeared colors.',
    params: [
      {
        key: 'noise',
        label: 'Noise',
        ...
        step: 0.01,
        def: 0.3,
        help: 'Amount of analog grain over the picture.',
      },
      {
        key: 'tracking',
        label: 'Tracking',
        ...
        step: 0.01,
        def: 0.4,
        help: 'Strength of the rolling tracking-error band.',
      },
      {
        key: 'wobble',
        ...
        step: 0.01,
        def: 0.3,
        help: 'How much scanlines sway left and right.',
      },
      {
        key: 'bleed',
        label: 'Color bleed',
        ...
        step: 0.01,
        def: 0.5,
        help: 'How far colors smear past their edges.',
      },
    ],
    frag: /* glsl */ `
...
void main(){
...

  {
    ...
    name: 'CRT',
    blurb:
      'Puts the video behind curved glass: scanlines, color fringing and phosphor glow like an old monitor.',
    params: [
      {
        key: 'scanline',
        label: 'Scanline size',
        ...
        step: 0.5,
        def: 3,
        help: 'Height of each scanline, in pixels.',
      },
      {
        key: 'curvature',
        label: 'Curvature',
        ...
        step: 0.01,
        def: 0.25,
        help: 'How much the screen bulges like a glass tube.',
      },
      {
        key: 'rgbsep',
        ...
        step: 0.1,
        def: 1.2,
        help: 'How far the color channels fringe apart, in pixels.',
      },
      {
        key: 'glow',
        label: 'Glow',
        ...
        step: 0.01,
        def: 0.4,
        help: 'Soft phosphor bloom around bright areas.',
      },
    ],
    frag: /* glsl */ `
...
void main(){
...

  {
    ...
    name: 'Xerox',
    blurb:
      'Turns the video into a harsh photocopy: crushed blacks, paper white, gritty grain and inked edges.',
    params: [
      {
        key: 'threshold',
        label: 'Threshold',
        ...
        step: 0.01,
        def: 0.5,
        help: 'Brightness where paper turns into ink.',
      },
      {
        key: 'grain',
        label: 'Grain',
        ...
        step: 0.01,
        def: 0.35,
        help: 'Toner noise breaking up the flat areas.',
      },
      {
        key: 'edgeStrength',
        label: 'Edge strength',
        ...
        step: 0.05,
        def: 1,
        help: 'How strongly outlines get traced in ink.',
      },
      {
        key: 'contrast',
        label: 'Contrast',
        ...
        step: 0.05,
        def: 1.8,
        help: 'How hard tones are pushed toward black or white.',
      },
    ],
    frag: /* glsl */ `
...
void main(){
...

  {
    ...
    name: 'Gradient Map',
    blurb:
      'Replaces the video’s brightness with colors picked from a gradient, like thermal imaging.',
    params: [
      {
        key: 'gradient',
        label: 'Gradient',
      ...
      },
      {
        ...
        step: 1,
        def: 32,
        help: 'Number of color steps — low values posterize into bands.',
      },
      {
        key: 'contrast',
        label: 'Contrast',
        ...
        step: 0.05,
        def: 1,
        help: 'Stretches brightness before it hits the gradient.',
      },
      {
        key: 'mixAmt',
        label: 'Mix',
        ...
        step: 0.01,
        def: 1,
        help: 'Blend between the original video and the mapped colors.',
      },
    ],
    frag: /* glsl */ `
    ...
    params: [
      {
        ...
        step: 0.01,
        def: 0.2,
        help: 'How strong a contour must be to show up.',
      },
      {
        key: 'thickness',
        label: 'Thickness',
        ...
        step: 0.1,
        def: 1,
        help: 'Width of the detected lines, in pixels.',
      },
      {
        key: 'glow',
        label: 'Glow',
        ...
        step: 0.05,
        def: 0.5,
        help: 'Soft halo around the lines.',
      },
      {
        key: 'edgeColor',
        label: 'Edge color',
...
void main(){
...

  {
    ...
    blurb:
      'Grows living coral-like patterns (a Gray–Scott simulation) that feed on the video underneath.',
    type: 'sim',
    params: [
      {
        key: 'scale',
        ...
        step: 0.05,
        def: 1,
        help: 'Size of the grown patterns — higher means bigger cells.',
      },
      {
        key: 'feed',
        label: 'Feed rate',
        ...
        step: 0.001,
        def: 0.037,
        help: 'How fast the growing chemical is replenished.',
      },
      {
        key: 'kill',
        label: 'Kill rate',
        ...
        step: 0.0005,
        def: 0.06,
        help: 'How fast the pattern chemical is removed — shapes the pattern style.',
      },
      {
        key: 'influence',
        ...
        step: 0.01,
        def: 0.5,
        help: 'How strongly bright video areas seed and steer the growth.',
      },
    ],
...
void main(){
...

  {
    ...
    name: 'Particles',
    blurb:
      'Dissolves the video into thousands of drifting dots that take their color from the pixels beneath them.',
    type: 'particles',
    params: [
      {
        key: 'count',
        ...
        step: 500,
        def: 15000,
        help: 'How many particles are alive at once.',
      },
      {
        key: 'size',
        label: 'Particle size',
        ...
        step: 0.5,
        def: 3,
        help: 'Diameter of each particle, in pixels.',
      },
      {
        key: 'motion',
        label: 'Motion',
        ...
        step: 0.01,
        def: 0.4,
        help: 'How restlessly particles wander on their own.',
      },
      {
        key: 'attraction',
        label: 'Image attraction',
        kind: 'range',
        min: 0,
        max: 1,
        step: 0.01,
        def: 0.6,
        help: 'How strongly particles are pulled toward bright areas.',
      },
    ],

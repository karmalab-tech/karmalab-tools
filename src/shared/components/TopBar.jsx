...
// (the Prompt Box mockup is deliberately not listed) and the API key button
// on the right, which opens the shared ApiKeyModal.
...
export function TopBar({ active, apiKeySet, onApiKeyClick }) {
  return (
    <div className="flex items-center justify-between gap-3">
      ...
      <button
        ...
        className={`${TAB} border-panel-border text-text-dim hover:border-accent hover:text-accent bg-transparent cursor-pointer inline-flex items-center gap-2`}
